        ...
        <div class="detail-layout">
          ...
          <div class="detail-left">
            ...
            <a-card :bordered="false" class="info-card">
              ...
              <h1 class="item-title" :title="item.title">{{ truncateTitle(item.title) }}</h1>
              ...
              <div class="condition-section">
                <ConditionTag :condition="item.conditionLevel || 'NEW'" />
              </div>
            ...
            <a-card :bordered="false" class="description-card">
              ...
              <div class="description-content" v-html="item.description || '<p style=\'color: #86909c\'>暂无描述</p>'"></div>
            </a-card>
          </div>
            ...
            <div class="sidebar-sticky">
              ...
              <a-card title="卖家信息" class="seller-card">
                <div class="seller-content">
                  ...
                  <div class="seller-details">
                    <div class="seller-name">{{ item.sellerName || '未知卖家' }}</div>
                    <div class="seller-rate">
                      <a-rate :model-value="item.sellerRating || 5" readonly :count="5" allow-half />
                      <span class="rate-text">{{ item.sellerRating?.toFixed(1) || '5.0' }} 分</span>
                    </div>
                  </div>
                </div>
                ...
                <div class="seller-stats">
                  <div class="stat-item">
                    ...
                    <span class="stat-value">{{ formatDate(item.sellerCreatedAt) }}</span>
                  </div>
                  <div class="stat-item">
                    <span class="stat-label">累计售出</span>
                    <span class="stat-value highlight">{{ item.sellerSoldCount || 0 }} 件</span>
                  </div>
                </div>
              ...
              <div class="action-group">
                <a-button
                  ...
                  long
                  class="buy-btn"
                  :disabled="!isBuyer || item.reviewStatus !== 'APPROVED'"
                  @click="handleBuy"
                >
...
import { getItemDetail, checkFavorite, addFavorite, removeFavorite, addToCart } from "../../services/api";
...
async function handleAddToCart() {
  if (!isBuyer.value) {
    Message.warning("请先登录买家账号");
    return;
  }
  if (item.value.reviewStatus !== "APPROVED") {
